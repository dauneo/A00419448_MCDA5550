...
/*
        ...
        Cursor cursor = db.query(BMIDatabaseHelper.TABLE_NAME,new String[]{"NAME", "PASSWORD","DATE","HEALTH_CARD_NUMB"},null,null,null,null,null);

        if(cursor.moveToFirst()){
            String name = cursor.getString(0);
            String pwd = cursor.getString(1);
            long dob = cursor.getLong(2);
            String hcrd = cursor.getString(3);
